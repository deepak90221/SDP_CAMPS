...
const Container = styled.div`
  ...
  align-items: center;
  height: 100vh;
  background-image: url('https://thumbs.dreamstime.com/b/registration-abstract-digital-banner-yellow-background-isolated-154757135.jpg');
...
const RegistrationForm = () => {
  ...
  const handleSubmit = (event) => {
    ...
    console.log('Form submitted:', { name, age, idNumber, address, skills, marks10th, marks12th, moreDetails });
